...
spins = [ 14.25 14.5 14.75 14 14.25 14.5 14.1 14.2 14.3 14.4 14.5 14.6 14.7 ];
...
for i = 1:numberOfFiles
    ...
    files(i).lambdasM = speedOfLight ./ (files(i).frequenciesTHz .* 10^9);
end


pics = [];
for i = 1:numberOfFiles
    fitresult = myGaussianFit(files(i).frequenciesTHz, files(i).yData,  196);
    newX = files(i).frequenciesTHz.';
